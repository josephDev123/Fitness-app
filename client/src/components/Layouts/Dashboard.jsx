  ...
  return (
   ...
   <>
      <header class="navbar navbar-dark sticky-top bg-success flex-md-nowrap p-0 shadow">
        ...
        <input class="form-control form-control-dark w-100 rounded-0 border-0 bg-body opacity-75" type="text" placeholder="Search" aria-label="Search"/>
        <div class="navbar-nav">
          <div class="nav-item text-nowrap">
            <button class="btn btn-sm btn-danger opacity-75 px-3 m-2" href="#">Sign out</button>
          </div>
        </div>
      </header>
          ...
          <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse show">
            <div class="position-sticky pt-3 sidebar-sticky">
              ...
              <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
                ...
                <Link class="link-secondary" href="#" aria-label="Add Link new report">
